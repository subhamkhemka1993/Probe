...
internal actual fun createDatabase(platform: ProbePlatformContext): ProbeDatabase = getProbeDatabase(getDatabaseBuilder())

internal actual fun createPreferencesDataStore(platform: ProbePlatformContext): DataStore<Preferences> = createDebugPreferencesDataStore()
