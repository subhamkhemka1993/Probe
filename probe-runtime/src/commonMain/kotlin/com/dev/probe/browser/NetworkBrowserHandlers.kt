...
internal class NetworkBrowserHandlers(private val repository: NetworkDebugRepository, private val maxEntries: Int) {
    ...
    fun buildCurl(call: NetworkCall): CurlResponse = CurlResponse(
        curl =
