...
internal object ProbePreviewData {
    ...
    val getServerError = NetworkCall(
        id = "call-get-500",
...
private fun previewPlugin(
    ...
    displayName: String,
    description: String = "",
): ProbePlugin = object : ProbePlugin {
