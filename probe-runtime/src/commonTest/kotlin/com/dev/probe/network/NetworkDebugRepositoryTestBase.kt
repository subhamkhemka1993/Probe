...
internal abstract class NetworkDebugRepositoryTestBase {
    protected abstract fun createRepository(config: ProbeCaptureLimits, scope: CoroutineScope): NetworkDebugRepository
    ...
    @Test
    fun evictsOldestWhenOverMaxEntries() = runTest {
    ...
    @Test
    fun searchFiltersByPath() = runTest {
